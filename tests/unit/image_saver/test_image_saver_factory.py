...
def test_create_with_config_overrides(tmp_path, config_loader):
    overrides = {"images_dir": str(tmp_path / "custom_images")}
    factory = ImageSaverFactory(config_loader, config_overrides=overrides)
