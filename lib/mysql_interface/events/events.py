...
def publish_event_from_schema(connector, schema_data, context_event):
    event_data = {
        ...
        "event_list_html_hash": context_event.get("event_list_html_hash"),
        "event_list_markdown_hash": context_event.get("event_list_markdown_hash"),
        "event_page_html_hash": context_event.get("event_page_html_hash"),
        "event_page_markdown_hash": context_event.get("event_page_markdown_hash"),
        "event_list_screenshot": context_event.get("event_list_screenshot"),
        "event_page_screenshot": context_event.get("event_page_screenshot"),
        "status": "published",
